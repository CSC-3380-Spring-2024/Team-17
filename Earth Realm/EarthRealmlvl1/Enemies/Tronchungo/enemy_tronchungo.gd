...
var enemy_tronchungo_death_effect = preload("res://EarthRealmlvl1/Enemies/Tronchungo/enemy_tronchungo_death_effect.tscn")
...
func _on_hurtbox_area_entered(area : Area2D):
	...
	if area.get_parent().has_method("get_damage_amount"):
		...
		if health_amount <= 0:
			var enemy_tronchungo_death_effect_instance  = enemy_tronchungo_death_effect.instantiate() as Node2D
